...
func DnsActionsSubscriber(conn *amqp.Connection) {
	ch, err := conn.Channel()
	...
	log.Printf("LISTENING-- DNS actions ")
...
func dnsActionsWorker(acks chan<- *amqp.Delivery, work *amqp.Delivery) {
